      ...
      <div className="row">
        <div className="twelve columns">
          <ul className="social-links no-print">
            ...
            <li>
              <a href="https://wa.me/+31686258143">
          ...
          <ul className="copyright">
            ...
            <li>
              {vocabulary.footer_realized_by}{" "}
              <a
                title={vocabulary.footer_realized_by_title}
                href="https://github.com/Nek97"
              >
                {vocabulary.footer_by_name}
              </a>
            </li>
          </ul>
        </div>
        <div id="go-top" className="no-print">
          <a
            ...
            title={vocabulary.footer_back_to_top}
            href="#home"
          >
