    ...
    <section id="contact">
      <div className="row section-head">
        ...
        <div className="ten columns">
          <p className="lead">{vocabulary.contact_section_lead}</p>
        </div>
      </div>
      <div className="row">
        <div className="eight columns">
            ...
            <fieldset>
              ...
              <div>
                <label htmlFor="contactEmail">
                  {vocabulary.contact_label_email}{" "}
                  <span className="required">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="contactSubject">
                  {vocabulary.contact_label_subject}
                </label>
                <input
                  type="text"
                  defaultValue=""
              ...
              <div>
                <label htmlFor="contactMessage">
                  {vocabulary.contact_label_message}{" "}
                  <span className="required">*</span>
                </label>
                <textarea
                  cols={50}
          ...
          <div id="message-success">
            ...
            {vocabulary.contact_message_success}
            <br />
          </div>
        </div>
        <aside className="four columns footer-widgets">
          ...
          <div className="widget widget_tweets">
            ...
            <ul id="twitter">
              {vocabulary.latest_tweets.map((tweet: any, idx: number) => (
                <li key={`tweet-${idx}`}>
                  <span>
